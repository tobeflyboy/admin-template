package com.nutcracker.core.aspect;
...
import com.nutcracker.system.model.entity.Log;
import com.nutcracker.system.service.LogService;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.nutcracker.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.nutcracker.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.nutcracker.common.annotation.Log logAnnotation, long executionTime, Long userId) {
