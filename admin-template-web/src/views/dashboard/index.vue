          ...
          <div class="flex items-end space-x-6">
            ...
            <div>
              ...
              <div class="mt-3 whitespace-nowrap">
                <el-link href="https://gitee.com/youlaiorg/admin-template-web" target="_blank">
                  <div class="i-svg:gitee text-lg color-#F76560" />
                </el-link>
                <el-divider direction="vertical" />
                <el-link href="https://github.com/youlaitech/admin-template-web" target="_blank">
          ...
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link
                type="primary"
                underline="never"
                href="https://gitee.com/youlaiorg/admin-template-web/releases"
                target="_blank"
              >
                完整记录
...
const vesionList = ref<VersionItem[]>([
  {
    ...
    content: "布局重写，代码规范重构。",
    link: "https://gitee.com/youlaiorg/admin-template-web/releases",
    tag: "里程碑",
  },
  {
    id: "2",
